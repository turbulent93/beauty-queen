...
namespace BeautyQueenApi.Migrations
{
    ...
    [Migration("20230818154432_AllowNullTimeInSchedule")]
    partial class AllowNullTimeInSchedule
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BeautyQueenApi.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Login = "login1",
                            Password = "$2a$11$lWk8.DD7ShwjAGFuH5Z7POqfa850CkPjNdXgG3fQ4eJyubQapez8e",
                            RoleId = 1
                        });
                });
