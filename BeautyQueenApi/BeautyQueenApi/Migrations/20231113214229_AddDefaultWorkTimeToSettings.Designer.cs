...
namespace BeautyQueenApi.Migrations
{
    ...
    [Migration("20231113214229_AddDefaultWorkTimeToSettings")]
    partial class AddDefaultWorkTimeToSettings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BeautyQueenApi.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Login = "login1",
                            Password = "$2a$11$.l6qUqiUvfuNVrU7D9APvekgfSXhYkdxSUJA3d4sGHvgRyw/I726G",
                            RoleId = 1
                        });
                });
